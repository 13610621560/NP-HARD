     ...
     L_LP=LP*1000;
      for  f=1:length(weizhi_LP(:,1))
          if shu_LP(f)==1
              ...
              L_LP(weizhi_LP(f,1),ttt)=(state_GP(f+4,i)-1)*duanLPshu*L_LP(weizhi_LP(f,1),ttt);%%实际负荷大小
          end
      end 
      P_PV(4)=PV(4)*1000;
      P_dgl(1)=-L_LP(24,ttt);%%ES1���ٸ���24
      P_dgl(2)=P_PV(2)-L_LP(32,ttt);%%ES2����pv1�͸���32
      if P_PV(3)>0.8*PV(3)*1000%%ES3����pv2������80%��磬С��20%�ŵ�
        P_dgl(3)=P_PV(3)*1000;
...
if ES(j)==0
      ...
      state_fengxian(i,es,k-t+1)=-(P_zong)/1000; %%ƽ��ڵ㷵�͵Ĺ���Ϊ��
      else  
